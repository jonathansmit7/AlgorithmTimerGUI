...
{	
    ...
    {		
        ...
        {	
            ...
            BitmapData rawData = retval.LockBits(new Rectangle(0, 0, retval.Width, retval.Height),	ImageLockMode.ReadWrite, retval.PixelFormat); //lock the image data in memory, allowing for both readin and writing.
            ...
            {	
                ...
                {					
                    ...
                    {						
                        ...
                        *(start + current + 2) ^= 0xff;//byte n where n%Alpha byte position was skipped. //usage of the modulo operator turned out to be so inefficient, that the code was replaced with this.					
                    }				
                }
